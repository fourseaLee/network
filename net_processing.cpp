...
//{
//    size_t max_extra_txn = g_max_extra_txn; //gArgs.GetArg("-blockreconstructionextratxn", DEFAULT_BLOCK_RECONSTRUCTION_EXTRA_TXN);
//    if (max_extra_txn <= 0)
//        return;
...
//            if (g_fListen && !IsInitialBlockDownload())
//            {
...
PeerLogicValidation::PeerLogicValidation(CConnman *_connman):connman(_connman)
{
