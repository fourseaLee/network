...
void TorController::add_onion_cb(TorControlConnection& _conn, const TorControlReply& reply)
{
    if (reply.code == 250) {
        ...
        service = LookupNumeric(std::string(service_id+".onion").c_str(), g_listen_port);
...
//        }
        ...
        _conn.Command(strprintf("ADD_ONION %s Port=%i,127.0.0.1:%i", private_key, g_listen_port, g_listen_port),
